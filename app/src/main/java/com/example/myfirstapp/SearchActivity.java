...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search_2 = findViewById(R.id.btn_search2);
        btn_search_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(SearchActivity.this,"Need search function",Toast.LENGTH_SHORT).show();
            }
        });
    }
}